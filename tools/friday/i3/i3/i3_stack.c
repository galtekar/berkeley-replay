...
i3_stack *alloc_i3_stack()
{
  ...
  panic("alloc_i3_stack: memory allocation error.\n");
  return NULL;
}
...
i3_stack *duplicate_i3_stack(i3_stack *s)
{
  ...
  panic("init_i3_stack: memory allocation error.\n");
  return NULL;
}
...
unsigned short get_i3_stack_len(i3_stack *stack)
{
  ...
  return sizeof(char) + num_ids*sizeof(ID); 
}
...
int check_i3_stack(char *p, unsigned short *length)
{
  ...
  *length = sizeof(char) + len*sizeof(ID);
  return FALSE;
}
