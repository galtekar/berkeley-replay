//---------------------------------------------------------- -*- Mode: C++ -*-
// $Id: qcdllist.h 367 2009-09-29 06:40:32Z sriramsrao $
//
// Created 2008/11/03
...
public:
        ...
        NodeT&  inNode)
    {
        ...
        if (theHeadPtr) {
            if (&inNode == theHeadPtr) {
                theHeadPtr = &ListOp::GetNext(*theHeadPtr);
            } else {
        ...
        NodeT** inListPtr)
    {
        ...
        if (theRetPtr) {
            if (theRetPtr == (theHeadPtr = ListOp::GetNextPtr(theRetPtr))) {
                theHeadPtr = 0;
            } else {
        ...
        NodeT&  inNode)
    {
        NodeT*& theHeadPtr = inListPtr[ListT];
        if (&inNode == theHeadPtr) {
            if ((theHeadPtr = ListOp::GetNextPtr(theHeadPtr)) == &inNode) {
                theHeadPtr = 0;
                return;
            }
        }
        ...
        NodeT** inListPtr)
    {
        ...
        if (theHeadPtr) {
            ...
            while ((thePtr = ListOp::GetNextPtr(thePtr)) != theHeadPtr) {
