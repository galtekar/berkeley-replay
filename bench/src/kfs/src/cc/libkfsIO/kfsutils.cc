//---------------------------------------------------------- -*- Mode: C++ -*-
// $Id: kfsutils.cc 326 2009-04-25 00:45:50Z sriramsrao $
//
// Created 2008/11/01
...
#if defined(KFS_OS_NAME_LINUX) && ! defined(KFS_USE_XFS_RESVSP)
#define KFS_USE_XFS_RESVSP
#endif

#ifdef KFS_USE_XFS_RESVSP
#include <xfs/xfs.h>
#endif
...
#if defined(__EXTENSIONS__) || defined(KFS_OS_NAME_DARWIN) || \
...
#endif /* KFS_USE_XFS_RESVSP */
    return (inFd < 0 ? -EINVAL : 0);
}

    /* static */ int
KFSUtils::AllocateFileSpace(
    int      inFd,
    int64_t  inSize,
    int64_t  inMinSize            /* = -1 */,
