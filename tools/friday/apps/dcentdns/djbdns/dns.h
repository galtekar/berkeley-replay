...
extern void dns_transmit_setserverport(unsigned short);
extern int dns_transmit_start(struct dns_transmit *,const char *,int,const char *,const char *,const char *);
extern int dns_transmit_start_chaos_txt(struct dns_transmit *,const char *,const char *,const char *);
