cmd_drivers/shpt/shpt_user.o := gcc -Wp,-MD,drivers/shpt/.shpt_user.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.1.3/include -Iinclude  -I/scratch/galtekar/src/logreplay/linux/linux-2.6.29.4-replay/arch/x86/include -include include/linux/autoconf.h -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Os -m32 -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2 -march=i686 -mtune=generic -Wa,-mtune=generic32 -ffreestanding -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -Iarch/x86/include/asm/mach-default -fno-stack-protector -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -Wdeclaration-after-statement -Wno-pointer-sign -fwrapv  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(shpt_user)"  -D"KBUILD_MODNAME=KBUILD_STR(shadow)"  -c -o drivers/shpt/.tmp_shpt_user.o drivers/shpt/shpt_user.c

deps_drivers/shpt/shpt_user.o := \
  drivers/shpt/shpt_user.c \
...
drivers/shpt/shpt_user.o: $(deps_drivers/shpt/shpt_user.o)
