...
int main(int argc,char **argv)
{
  ...
  while (flag0 || inbuflen || partial.len || xnum) {
	...
	timetaken = (x[0].ended.tv_sec - x[0].started.tv_sec) * 1000000 + (x[0].ended.tv_usec - x[0].started.tv_usec);
